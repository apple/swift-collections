...
struct Fixture {
  ...
  init(title: String, contents: [String]) {
    ...
    let maxDepth = ShareableDictionary<Int, Int>._maxDepth
...
extension LifetimeTracker {
  func shareableSet<Element: Hashable>(
    ...
    map: ShareableSet<LifetimeTracked<Element>>,
    ...
    return (ShareableSet(ref2), ref)
  }

  func shareableSet(
    for fixture: Fixture
  ) -> (
    map: ShareableSet<LifetimeTracked<RawCollider>>,
  ...
  func shareableDictionary<Key, Value>(
    ...
    map: ShareableDictionary<LifetimeTracked<Key>, LifetimeTracked<Value>>,
    ...
    return (ShareableDictionary(uniqueKeysWithValues: ref2), ref)
  }
  ...
  func shareableDictionary<Value>(
    ...
    map: ShareableDictionary<LifetimeTracked<RawCollider>, LifetimeTracked<Value>>,
  ...
  func shareableDictionary(
    ...
    map: ShareableDictionary<LifetimeTracked<RawCollider>, LifetimeTracked<Int>>,
