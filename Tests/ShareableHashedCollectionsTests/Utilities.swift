...
extension LifetimeTracker {
  func shareableDictionary<Keys: Sequence>(
    ...
    dictionary: ShareableDictionary<LifetimeTracked<Int>, LifetimeTracked<Int>>,
  ...
  where Keys.Element == Int
  {
    ...
    let dictionary = ShareableDictionary(
...
extension LifetimeTracker {
  func shareableDictionary<Payloads: Sequence, G: DataGenerator>(
    ...
    map: ShareableDictionary<LifetimeTracked<G.Key>, LifetimeTracked<G.Value>>,
  ...
  where Payloads.Element == Int
  {
    ...
    let map = ShareableDictionary(uniqueKeysWithValues: gen())
  ...
  func shareableDictionary<Keys: Sequence>(
    ...
    map: ShareableDictionary<LifetimeTracked<Int>, LifetimeTracked<Int>>,
...
func expectEqualDictionaries<Key: Hashable, Value: Equatable>(
  _ map: ShareableDictionary<Key, Value>,
