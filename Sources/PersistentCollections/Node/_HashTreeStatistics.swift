...
extension _Node {
  internal func gatherStatistics(
    _ level: _Level, _ stats: inout _HashTreeStatistics
  ) {
    ...
    read {
      ...
      stats.childBytes += $0.childCount * MemoryLayout<_RawNode>.stride
      ...
      let end = $0._memory + capacity * MemoryLayout<_RawNode>.stride
