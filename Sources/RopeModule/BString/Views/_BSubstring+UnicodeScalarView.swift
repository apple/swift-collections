...
@available(macOS 13.3, iOS 16.4, watchOS 9.4, tvOS 16.4, *)
extension _BString {
  public init(_ unicodeScalars: _BSubstring.UnicodeScalarView) {
...
extension _BSubstring.UnicodeScalarView {
  public var base: _BString.UnicodeScalarView { _base.unicodeScalars }
}
...
extension _BSubstring.UnicodeScalarView: Sequence {
  ...
  public struct Iterator: IteratorProtocol {
    var _it: _BString.UnicodeScalarView.Iterator
