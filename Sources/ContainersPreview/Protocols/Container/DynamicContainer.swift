...
extension DynamicContainer where Self: ~Copyable, Element: ~Copyable {
  ...
  /// Creates a new instance of the container, populating it with all items
  /// generated by a given producer.
  ///
  /// - Parameters:
  ///    - minimumCapacity: The desired minimum storage capacity, or nil to
  ///       indicate that the result should be sized automatically.
