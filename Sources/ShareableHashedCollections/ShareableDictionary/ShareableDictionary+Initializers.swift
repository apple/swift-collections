...
extension ShareableDictionary {
  ...
  /// - Complexity: O(1)
  @inlinable
  public init(_ other: ShareableDictionary<Key, Value>) {
    self = other
  }
  ...
  ///
  ///     let firstValues = ShareableDictionary(
  ///       pairsWithDuplicateKeys,
  ///       uniquingKeysWith: { (first, _) in first })
  ///     // ["a": 1, "b": 2]
  ///
  ///     let lastValues = ShareableDictionary(
  ///       pairsWithDuplicateKeys,
...
extension ShareableDictionary {
  ...
  ///     let studentsByLetter = ShareableDictionary(grouping: students, by: { $0.first! })
