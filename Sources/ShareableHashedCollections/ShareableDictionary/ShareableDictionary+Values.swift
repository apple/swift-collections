...
#if swift(>=5.5)
extension ShareableDictionary.Values: Sendable
where Key: Sendable, Value: Sendable {}
#endif

extension ShareableDictionary.Values: CustomStringConvertible {
...
extension ShareableDictionary.Values: CustomDebugStringConvertible {
  /// A textual representation of this instance, suitable for debugging.
  public var debugDescription: String {
    _arrayDescription(
      for: self,
      debug: true,
      typeName: "\(ShareableDictionary._debugTypeName()).Values")
  }
}

extension ShareableDictionary.Values: Sequence {
...
#if swift(>=5.5)
extension ShareableDictionary.Values.Iterator: Sendable
where Key: Sendable, Value: Sendable {}
#endif

// Note: This cannot be a MutableCollection because its subscript setter
// needs to invalidate indices.
extension ShareableDictionary.Values: Collection {
...
#if false
extension ShareableDictionary.Values: BidirectionalCollection {
