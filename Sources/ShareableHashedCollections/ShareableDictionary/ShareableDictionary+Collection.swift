...
#if swift(>=5.5)
extension ShareableDictionary.Index: @unchecked Sendable
where Key: Sendable, Value: Sendable {}
#endif

extension ShareableDictionary.Index: Equatable {
...
extension ShareableDictionary.Index: Comparable {
...
extension ShareableDictionary.Index: Hashable {
...
extension ShareableDictionary.Index: CustomStringConvertible {
...
extension ShareableDictionary.Index: CustomDebugStringConvertible {
...
extension ShareableDictionary: Collection {
  ...
  ///    (The result can be negative, even though `ShareableDictionary` is not
  ...
  ///     `ShareableDictionary` isn't a bidirectional collection.
...
// `ShareableDictionary`.
extension ShareableDictionary: BidirectionalCollection {
