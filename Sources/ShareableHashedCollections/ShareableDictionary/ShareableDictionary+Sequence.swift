...
extension ShareableDictionary: Sequence {
...
#if swift(>=5.5)
extension ShareableDictionary.Iterator: @unchecked Sendable
where Key: Sendable, Value: Sendable {}
#endif

extension ShareableDictionary.Iterator: IteratorProtocol {
  /// The element type of a dictionary: a tuple containing an individual
  /// key-value pair.
  public typealias Element = (key: Key, value: Value)
