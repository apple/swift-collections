...
// `ShareableDictionary` therefore encodes/decodes itself exactly the same as
...
extension ShareableDictionary: Encodable
...
extension ShareableDictionary: Decodable
