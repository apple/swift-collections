...
#if swift(>=5.5)
extension ShareableSet.Index: @unchecked Sendable
where Element: Sendable {}
#endif

extension ShareableSet.Index: Equatable {
...
extension ShareableSet.Index: Comparable {
...
extension ShareableSet.Index: Hashable {
...
extension ShareableSet.Index: CustomStringConvertible {
...
extension ShareableSet.Index: CustomDebugStringConvertible {
...
extension ShareableSet: Collection {
  ...
  ///    (The result can be negative, even though `ShareableSet` is not a
  ...
  ///     `distance` is allowed to be negative even though `ShareableSet`
...
// `ShareableSet`.
extension ShareableSet: BidirectionalCollection {
